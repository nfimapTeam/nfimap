  ...
  useEffect(() => {
    ...
    globalConcerts.forEach((concert) => {
      ...
      const infoWindowContent = `
        <div style="width: 320px; max-width: 320px; font-family: Arial, sans-serif; padding: 10px; background-color: #fff; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); border-radius: 4px;">
